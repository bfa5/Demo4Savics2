...
public class FoodsAdapter extends RecyclerView.Adapter<FoodsAdapter.UsersViewHolder> {
    Context context;
    List<UserListResponse> userListResponseData;

    public FoodsAdapter(Context context, List<UserListResponse> userListResponseData) {
